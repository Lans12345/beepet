...
class TableTabAdmin extends StatefulWidget {
  var data;

  TableTabAdmin({super.key, required this.data});

  @override
  State<TableTabAdmin> createState() => _TableTabAdminState();
}

class _TableTabAdminState extends State<TableTabAdmin> {
